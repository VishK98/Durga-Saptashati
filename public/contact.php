    ...
    <div class="contact">
        <div class="container-fluid">
            ...
            <div class="contact-form">
                ...
                <form name="sentMessage" id="contactForm" action="<?= url('contact.php') ?>" method="POST" novalidate="novalidate">
                    <div class="control-group">
                        <input type="text" class="form-control" name="name" id="name" placeholder="Your Name" required="required"
                            data-validation-required-message="Please enter your name" value="<?= isset($name) ? $name : '' ?>" />
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="control-group">
                        <input type="email" class="form-control" name="email" id="email" placeholder="Your Email" required="required"
                            data-validation-required-message="Please enter your email" value="<?= isset($email) ? $email : '' ?>" />
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="control-group">
                        <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" required="required"
                            data-validation-required-message="Please enter a subject" value="<?= isset($subject) ? $subject : '' ?>" />
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="control-group">
