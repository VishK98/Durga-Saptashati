        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="coming-soon-card" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="1000">
                    ...
                    <h1 class="coming-soon-title">Our Story</h1>
                    <h2 class="coming-soon-subtitle">Journey & History Coming Soon</h2>
                    <p class="coming-soon-text">
                        We're preparing to share the inspiring story of how Durga Saptashati Foundation began,
                        our founding principles, the journey of growth, and the milestones that shaped our mission
                        to serve humanity through divine grace. Discover the vision that started it all.
                    </p>
